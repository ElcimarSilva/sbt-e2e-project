...
describe("Mobile - Tests on home page SBT TV", () => {
  ...
  it("Mobile - Home - deve verificar o menu de hamburger", () => {
    ...
    homePage
      ...
      .eq("1")
      .should("have.attr", "href")
      .and("contain", "/novidades");
    homePage
      .getBurgerMenuContainer()
      .find("a")
      .eq("2")
      .should("have.attr", "href")
      .and("contain", "/tecnicos");
    homePage
      .getBurgerMenuContainer()
      .find("a")
      .eq("3")
  ...
  it("Mobile - Home - deve verificar e abrir um video na sessão videos", () => {
    ...
    homePage
      .getVideoSession()
      .find("a")
      .and("have.attr", "href", "/videos")
      .and("contain.text", "Ver tudo");
    homePage
      .getVideoSession()
      .find(".snap-start")
      .find("a")
  ...
  it("Mobile - Home - deve abrir o instagram ao clicar em Ver tudo", () => {
    cy.get('[href="https://www.instagram.com/thevoicebrasil"]')
      .should("be.visible")
